		...
		<div class="div-row">
			<div class="div-column-r">
				<?php if(empty($this->btnOptions)):?>
					...
					?>
					<?php if($action=='admin'):?>
					<a class="btn btn-success btn-sm" href="<?php echo $this->createUrl('create')?>"><i class="fa fa-plus"></i>&nbsp;<?php echo Yii::t('main','Create New')?></a>
					...
					<a class="btn btn-primary btn-sm submit" href="#"><i class="fa fa-save"></i>&nbsp;<?php echo Yii::t('main','Save')?></a>
					<a class="btn btn-primary btn-sm apply" href="#"><i class="fa fa-save"></i>&nbsp;<?php echo Yii::t('main','Save & Continue')?></a>
					<a class="btn btn-warning btn-sm" href="<?php echo $this->createUrl('admin')?>"><i class="fa fa-close"></i>&nbsp;<?php echo Yii::t('main','Close')?></a>
